...
a =[position[79].get_lat(), position[79].get_long()]
b =[position[89].get_lat(), position[89].get_long()]
c =[position[99].get_lat(), position[99].get_long()]


print("{}".format(get_angle(a,b,c)))

print("{}".format(turning(position, 12123,4)))
